...
/*  char buf[70];
  ...
  */
  ...
  //!-Start modification by CV for handling different kinds of formats of .ppm file, 11/27/2018
  char buf[70];
  ...
  fgets(buf,70,fp);
//!-End modification by CV for handling different kinds of formats of .ppm file, 11/27/2018
  //********************************************************
